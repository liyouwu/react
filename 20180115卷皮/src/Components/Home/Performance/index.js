...
class Performance extends Component{
	...
	componentDidMount(){
		axios.get("/api/getGoods?page=1&zy_ids=p8_c4_l4_0&app_name=zhe&catname=newest_zhe&flag=tab_hpzc").then(res=>{
			this.setState({
	...
	render(){
		...
		>
				...
				<span className="span1">{item.coupon_tips}</span>
	...
	loaderMoreFunc(){
		...
		axios.get(`/api/getGoods?page=${this.current}&zy_ids=p8_c4_l4_0&app_name=zhe&catname=newest_zhe&flag=tab_hpzc"`).then(res=>{
	    	this.setState({
